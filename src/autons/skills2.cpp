...
void skills2() {
    ...
    // Get matchloader
    chassis.moveToPoint(-48, -48, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed = 5, .earlyExitRange = 3});
    ...
    // Score long goal
    chassis.moveToPoint(-28, -47.25, 2000, {.forwards = false, .minSpeed = 100});
    // pros::Task align_score1{[=]{
    //     while(long_goal_check.get() > 85) { pros::delay(50);}
    //     upper.move(127);
    // }};
    ...
    chassis.moveToPoint(22, -22, 2000, {.forwards = true, .maxSpeed = 100,.minSpeed=100,.earlyExitRange=5});
    // chassis.turnToHeading(90, 500);
    ...
    // chassis.turnToHeading(180, 500, {.minSpeed = 5, .earlyExitRange = 3});
    chassis.moveToPoint(47, -49, 2000, {.forwards = true, .maxSpeed = 100});
    ...
    odom_state = false;
    pros::delay(300);
    chassis.turnToPoint(43, 48, 2000, {.forwards=false});
    ...
    // Score long goal 3
    chassis.moveToPoint(26, 48.5, 2000, {.forwards = false, .minSpeed = 100});
    ...
    matchload.set_value(false);
    chassis.turnToHeading( -135, 500, {.minSpeed = 5, .earlyExitRange = 3});
    ...
    // Get 5th trio
    chassis.turnToPoint(-22, 22, 500);
    chassis.moveToPoint(-22, 22, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed = 100, .earlyExitRange = 5});
    ...
    // Go to matchloader 4
    chassis.moveToPoint(-47, 47, 2000, {.forwards = true, .maxSpeed = 127, .minSpeed=5, .earlyExitRange=2});
    level.set_value(false);
    matchload.set_value(true);
    chassis.turnToHeading(-90, 500, {});
    // chassis.setPose(chassis.getPose().x, 72 - RIGHT_DIST_OFFSET - right_dist.get() * MM_TO_IN, chassis.getPose().theta); 
