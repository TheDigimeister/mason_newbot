...
void skills_safe() {
    ...
    // chassis.setPose(positionFromRaycast(front_dist.get()*MM_TO_IN, FRONT_DIST_OFFSET, EAST), positionFromRaycast(right_dist.get()*MM_TO_IN, RIGHT_DIST_OFFSET, SOUTH), 90);
    ...
    // 2nd matchload
    chassis.moveToPoint(59, -47.75, 2500, {.forwards=true, .maxSpeed=45, .minSpeed=45, .earlyExitRange=1}, false);
    left_mg.move(-50);
    right_mg.move(-50);
    pros::delay(100);
    left_mg.move(45);
    ...
    // 3rd matchload
    chassis.moveToPoint(59, 47, 2000, {.forwards=true, .maxSpeed=45, .minSpeed=45, .earlyExitRange=1}, false);
    left_mg.move(-50);
    right_mg.move(-50);
    pros::delay(100);
    left_mg.move(45);
    ...
    // 4th matchload
    chassis.moveToPoint(-59, 48.8, 2500, {.forwards=true, .maxSpeed=45, .minSpeed=45, .earlyExitRange=1}, false);
    left_mg.move(-50);
    right_mg.move(-50);
    pros::delay(100);
    left_mg.move(45);
    ...
    lower.move(127);
    chassis.moveToPoint(-48, 48, 2000, {.forwards=true, .maxSpeed=127, .minSpeed=5, .earlyExitRange=5}, true);
    chassis.turnToPoint(-24, 24, 1000);
    chassis.moveToPoint(-24, 24, 2000, {.forwards=true, .maxSpeed=127, .minSpeed=5, .earlyExitRange=5}, true);
    chassis.turnToPoint(-24, -24, 1000);
    chassis.moveToPoint(-24, -24, 2000, {.forwards=true, .maxSpeed=127, .minSpeed=5, .earlyExitRange=5}, true);
    chassis.moveToPoint(-24, 24, 2000, {.forwards=false, .maxSpeed=127}, true);
    
    chassis.turnToPoint(-8, 8, 2000, {.forwards=false});
    chassis.moveToPoint(-8, 8, 2000, {.forwards=false, .maxSpeed=127, .minSpeed=40, .earlyExitRange=1}, false);
    level.set_value(true);
    pros::delay(200);
    upper.move(64);
    pros::delay(1000);
    ...
    chassis.moveToPoint(-54, 40, 2000, {.forwards=true, .maxSpeed=127, .minSpeed=5, .earlyExitRange=5}, true);
    chassis.turnToPoint(-62, 16, 1000);
    chassis.moveToPoint(-62, 16, 2000, {.forwards=true, .maxSpeed=127, .minSpeed=5, .earlyExitRange=5}, true);
