...
void leftslow7Ball() {
    ...
    chassis.moveToPoint(-24, 24, 2000, {.maxSpeed = 127, .minSpeed=5, .earlyExitRange=10});
    pros::delay(500);
    
    chassis.turnToPoint(-46, 46, 700, {.maxSpeed=80, .minSpeed=5, .earlyExitRange=5}, false);
    matchload.set_value(true);
    // back up
    chassis.moveToPoint(-52, 48, 1500, {.maxSpeed=80});
    ...
    chassis.moveToPoint(-62, 48, 1100, {.forwards=true, .maxSpeed=55, .minSpeed = 55});
    pros::delay(600);
    ...
    chassis.moveToPoint(-24, 48, 2500, {.forwards=false});
    ...
    right_mg.move(50);
    pros::delay(250);
    chassis.turnToHeading(315, 500, {.minSpeed=5, .earlyExitRange=1}, false);
    left_mg.move(-50);
    right_mg.move(-50);
    pros::delay(500);
    descore.set_value(false);
