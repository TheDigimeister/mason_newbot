...
void rightSoloAWP() {
    ...
    // right_mg.move(0);
    // pros::delay(200);
    chassis.swingToHeading(0, lemlib::DriveSide::RIGHT, 1300, {.minSpeed=30}, false);
    ...
    left_mg.move(0);
    right_mg.move(0);
    // chassis.turnToPoint(-12.5, 8.5, 1000, {.forwards=false, .maxSpeed=80, .minSpeed=20}, false);
    // quintic::moveToPoint(chassis,-12.5,8.5,1000,{.forwards=false, .async=false});
    ...
    chassis.moveToPoint(-50, 44, 1000, {.maxSpeed=80});
    pros::delay(600);
    level.set_value(true);
